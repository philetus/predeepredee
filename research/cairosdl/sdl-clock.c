...
<link rel='alternate' title='Atom feed' href='http://cgit.freedesktop.org/~joonas/cairosdl/atom/sdl-clock.c?h=demos' type='application/atom+xml'/>
</head>
<body>
...
<div class='footer'>generated  by cgit v0.8.3-6-g21f6 at 2010-02-04 22:01:35 (GMT)</div>
</div> <!-- id=cgit -->
</body>
</html>
